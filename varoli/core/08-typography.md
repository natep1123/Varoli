...
Varoli uses capitalization to mark the attractor state of a word: the structural core the word resolves around.

The attractor state is marked in uppercase. All other characters are lowercase.

Examples:
- aVa — water eternal, V is the attractor

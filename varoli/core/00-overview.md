...
If you are new to Varoli, begin with `../introduction.md` before reading anything here. The introduction is the experiential entry point. This folder is the formal system that underlies it.
...
`./04-operators.md` is a compressed reference for the operator. For full definition see `./05-phonemic-schemas.md`.
...
The grammar files in `../grammar/` depend on this folder. The lexicon files in `../lexicon/` depend on both.

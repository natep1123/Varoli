...
This document defines the complete Invariant Compositional Architecture (ICA) as a formal system. It contains three axioms, seven derived laws, and three emergent behaviors. Everything in this document is expressed using only the terminology defined in `./00-g0-ica-terminology.md`. No application-specific language is used. No implementation details are included.
